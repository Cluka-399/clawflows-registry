  ...
  <div class="container">
    ...
    <div class="hero">
      ...
      <aside class="hero-side">
        ...
        ${requirements.includes('agent-analytics') ? '<p style="margin-top:1rem; color: var(--muted); font-size:.9rem;">This flow expects an analytics service layer. <a href="https://agentanalytics.sh" target="_blank" rel="noopener noreferrer">Agent Analytics ↗</a></p>' : ''}
      </aside>
    </div>
